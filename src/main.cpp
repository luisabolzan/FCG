...
int main(int argc, char* argv[])
{
    ...
    GLFWwindow* window;
    window = glfwCreateWindow(800, 600, "INF01047 - 584789 - Rafael Silveira Bandeira", NULL, NULL);
    if (!window)
    {
        glfwTerminate();
...
void ComputeNormals(ObjModel* model)
{
    ...
    // Segundo, computamos as normais dos VÉRTICES através do meto do proposto
